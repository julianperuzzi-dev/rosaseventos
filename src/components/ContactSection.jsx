...
const ContactSection = () => {
  return (
    <section id="contact" className="py-20 bg-black text-white md:min-h-screen md:py-40">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Imagen y Mapa de Lado */}
        <div className="hidden md:flex flex-col gap-6">
          <img
            src="https://images.pexels.com/photos/2267898/pexels-photo-2267898.jpeg"
            alt="Contáctanos"
            className="rounded-lg shadow-lg object-cover h-96 w-full border-4 border-amber-500"
          />

          {/* Mapa de Google embebido */}
          <div className="rounded-lg overflow-hidden shadow-lg border-4 border-amber-500">
            <iframe
              title="Google Maps"
        ...
        {/* Sección de Contacto */}
        <div className="flex flex-col justify-center text-center md:text-left bg-black p-8 rounded-lg shadow-lg border-4 border-amber-500 mx-3 md:mx-0">
          <h2 className="text-4xl font-bold mb-6 text-amber-500">Contáctanos</h2>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-amber-500 text-black py-3 px-6 rounded-full shadow-lg hover:bg-amber-600 transition duration-300 mb-4 w-full text-center md:w-fit"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-black text-amber-500 border border-amber-500 py-3 px-6 rounded-full shadow-lg hover:bg-amber-500 hover:text-black transition duration-300 w-full text-center md:w-fit"
          >
